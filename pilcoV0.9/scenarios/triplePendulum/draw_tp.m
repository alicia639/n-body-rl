...
pendulum3 = [-l*(sth1-sth2), l*(cth1+cth2); -l*(sth2-sth3), l*(cth2+cth3)];
...
plot(-l*(sth2-sth3), l*(cth2+cth3),'k.','markersize',24)
plot(-l*(sth2-sth3), l*(cth3+cth3),'y.','markersize',14)
...
try
  if max(max(S))>0
    [M1 S1 M2 S2 M3 S3] = getPlotDistr_dp(M, S, l, l, l);
